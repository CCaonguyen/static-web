                            ...
                            <div class="classy-menu">
                                ...
                                <div class="classynav">
                                    <ul>
                                        ...
                                        <li><a href="<?php echo e(asset('admin')); ?>">Home</a></li>
                                        <li><a href="<?php echo e(asset('list-audio')); ?>">Product</a></li>
                                        
                                        <li><a href="<?php echo e(asset('showupdate')); ?>">Add Product</a></li>
                                    </ul>
                                    ...
                                    <div class="login-register-cart-button d-flex align-items-center">
                                        ...
                                        <div class="login-register-btn mr-50">
                                            <a href="<?php echo e(asset('login_url')); ?>" id="loginBtn">Login</a>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="browse-by-catagories catagory-menu d-flex flex-wrap align-items-center mb-70">
                               <div class="col-10 agileits_search">
                                       <form action="<?php echo e(route('search1')); ?>" method="POST" enctype="multipart/form-data">
                                           <?php echo csrf_field(); ?>
                ...
                <div class="col-12 col-md-6">
                    <div class="footer-nav">
                        <ul>
                            ...
                            <li><a href="<?php echo e(asset('add')); ?>">Add</a></li>
                            <li><a href="<?php echo e(asset('/Login')); ?>">Login</a></li>
                            <li><a href="<?php echo e(asset('add')); ?>">Add Product</a></li>
                                <!-- Cart Button -->
...
<?php /**PATH C:\xampp\htdocs\Test\resources\views/admin.blade.php ENDPATH**/ ?>