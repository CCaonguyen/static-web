 ...
 <?php $__env->startSection('content'); ?>
     ...
     <!-- Stylesheet -->
     <link rel="stylesheet" href="<?php echo e(asset('css/albums.css')); ?>">
...
<!-- search -->
                             ...
                             <?php if(session('sucmessage')): ?>
                                 <span >
                                    <strong><?php echo e(session('sucmessage')); ?></strong></span>
                             <?php endif; ?>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-album-area">
                        <div class="album-thumb">
                            <img src="<?php echo e($audio->Image); ?>">
                        ...
                        <div class="album-info">
                            <a href="#">
                                <h5><?php echo e($audio->name_product); ?></h5>
                            </a>

                            <audio preload="auto" controls>
                                <source src="<?php echo e($audio->link); ?>">
                            </audio>
                            
                        </div>
                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                            <form action="<?php echo e(asset('shoping')); ?>">
                                <fieldset>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Test\resources\views/albums.blade.php ENDPATH**/ ?>