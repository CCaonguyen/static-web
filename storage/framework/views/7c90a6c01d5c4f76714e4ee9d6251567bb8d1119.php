...
<?php endif; ?>
                                    ...
                                    <?php if(auth()->guard()->guest()): ?>
                                        ...
                                        <div class="login-register-cart-button d-flex align-items-center">
                                            ...
                                            <div class="login-register-btn mr-50">
                                                <a href="<?php echo e(asset('register_url')); ?>" id="loginBtn"> Register</a>
                                            </div>
                                        </div>
                                        <?php else: ?>
                                        <div class="login-register-cart-button d-flex align-items-center">
                                            <div class="login-register-btn mr-50">
                                                <a href="<?php echo e(asset('logout')); ?>" id="loginBtn">Logout</a>
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-12 col-md-6">
                    <a href="#"><img src="<?php echo e(asset('Image/core-img/logo.png')); ?>" alt=""></a>
                ...
                <div class="col-12 col-md-6">
                    <div class="footer-nav">
                        <ul>
                            ...
                            <li><a href="<?php echo e(asset('shoping')); ?>">Shoping</a></li>
                            <li> <a href="<?php echo e(asset('login_url')); ?>" id="loginBtn">Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Test\resources\views/layout.blade.php ENDPATH**/ ?>